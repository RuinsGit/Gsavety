    ...
    <div class="container-fluid p-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center" style="margin-top: 100px;">
                <h5 class="mb-0">Yeni Servis hero</h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('back.pages.service-heroes.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="image_alt_az" name="image_alt_az" rows="3" required>{{ old('image_alt_az') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label for="image_alt_en" class="form-label">Foto Alt (EN) <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="image_alt_en" name="image_alt_en" rows="3" required>{{ old('image_alt_en') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label for="image_alt_ru" class="form-label">Foto Alt (RU) <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="image_alt_ru" name="image_alt_ru" rows="3" required>{{ old('image_alt_ru') }}</textarea>
                            </div>
                        </div>
                    </div>
