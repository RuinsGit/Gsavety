...
@section('title', 'Yeni Məhsul Rəngi Əlavə Et')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Yeni Məhsul Rəngi Əlavə Et</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.pages.product_colors.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="tab-content p-3 text-muted">
                                ...
                                <div class="tab-pane active" id="az" role="tabpanel">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('color_name_az') is-invalid @enderror" id="color_name_az" name="color_name_az" value="{{ old('color_name_az') }}" required>
                                        @error('color_name_az')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="tab-pane" id="en" role="tabpanel">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('color_name_en') is-invalid @enderror" id="color_name_en" name="color_name_en" value="{{ old('color_name_en') }}" required>
                                        @error('color_name_en')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="tab-pane" id="ru" role="tabpanel">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('color_name_ru') is-invalid @enderror" id="color_name_ru" name="color_name_ru" value="{{ old('color_name_ru') }}" required>
                                        @error('color_name_ru')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('color_code') is-invalid @enderror" id="color_code" name="color_code" value="{{ old('color_code') }}" placeholder="#FFFFFF">
                                        <input type="color" class="form-control form-control-color" id="color_picker" value="{{ old('color_code', '#FFFFFF') }}" title="Rəng seçin">
                                    </div>
                                    @error('color_code')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
