        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Yeni Blog Yazısı</h4>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('short_description_az') is-invalid @enderror" id="short_description_az" name="short_description_az" rows="3" required>{{ old('short_description_az') }}</textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control editor @error('description_az') is-invalid @enderror" id="description_az" name="description_az" rows="5">{{ old('description_az') }}</textarea>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('short_description_en') is-invalid @enderror" id="short_description_en" name="short_description_en" rows="3">{{ old('short_description_en') }}</textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control editor @error('description_en') is-invalid @enderror" id="description_en" name="description_en" rows="5">{{ old('description_en') }}</textarea>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('short_description_ru') is-invalid @enderror" id="short_description_ru" name="short_description_ru" rows="3">{{ old('short_description_ru') }}</textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control editor @error('description_ru') is-invalid @enderror" id="description_ru" name="description_ru" rows="5">{{ old('description_ru') }}</textarea>
