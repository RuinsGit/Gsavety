        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Partner Düzənlə</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Ana səhifə</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('back.pages.partners.index') }}">Partnyorlar</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.pages.partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom nav-justified mb-4" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#partner_info" role="tab" style="color:rgb(0, 0, 0);">
                                        <i class="ri-list-check-2 me-1 align-middle"></i> Partner Məlumatları
                                    </a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content p-3">
                                <!-- Partner Məlumatları Sekmesi -->
                                <div class="tab-pane active" id="partner_info" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card border shadow-none mb-4">
                                                <div class="card-header bg-light">
                                                    <h5 class="card-title mb-0">Partner Logosu</h5>
                                                </div>
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        <label for="image" class="form-label">Şəkil</label>
                                                        <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image">
                                                        <div class="mt-2 text-muted small">Tövsiyə olunan ölçü: 300x200px, Şəffaf arxa fon (PNG)</div>
                                                        @error('image')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    <div id="image-preview" class="mt-3 {{ $partner->image ? '' : 'd-none' }}">
                                                        <img src="{{ $partner->image ? asset($partner->image) : '' }}" alt="Önizləmə" class="img-thumbnail" style="max-height: 200px;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-check form-switch form-switch-success mb-3">
                                                        <input class="form-check-input" type="checkbox" role="switch" id="status" name="status" {{ old('status', $partner->status) ? 'checked' : '' }}>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_az') is-invalid @enderror" id="title_az" name="title_az" value="{{ old('title_az', $partner->title_az) }}" required>
                                                        @error('title_az')
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" id="title_en" name="title_en" value="{{ old('title_en', $partner->title_en) }}">
                                                        @error('title_en')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_ru') is-invalid @enderror" id="title_ru" name="title_ru" value="{{ old('title_ru', $partner->title_ru) }}">
                                                        @error('title_ru')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-end">
                                    ...
                                    <a href="{{ route('back.pages.partners.index') }}" class="btn btn-secondary">
