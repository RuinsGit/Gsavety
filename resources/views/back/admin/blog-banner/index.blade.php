        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Blog Bannerlar</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Ana səhifə</a></li>
                            <li class="breadcrumb-item active">Blog Bannerlar</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8 text-end">
                                <a href="{{ route('back.pages.blog-banner.create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="{{ route('back.pages.blog-banner.edit', $banner->id) }}" class="btn btn-info btn-sm">
                                                    <i class="ri-pencil-fill"></i>
                                                </a>
                                                <form action="{{ route('back.pages.blog-banner.destroy', $banner->id) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
