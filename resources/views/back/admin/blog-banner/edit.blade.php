...
@section('title', 'Blog Banner Düzənlə')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Blog Banner Düzənlə</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.pages.blog-banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-end">
                                    ...
                                    <a href="{{ route('back.pages.blog-banner.index') }}" class="btn btn-secondary">
