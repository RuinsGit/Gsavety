...
@section('title', 'Product Banner Düzənlə')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Product Banner Düzənlə</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Ana səhifə</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('back.pages.product-banner.index') }}">Product Bannerlar</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.pages.product-banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-text">Tövsiyə olunan şəkil ölçüsü: 1920x600px</div>
                                                        @error('image')
                                                    ...
                                                    <!-- Mevcut şəkil -->
                                                    <div class="mt-3">
                                                        <label class="form-label d-block">Mövcud Şəkil</label>
                                                        @if($banner->image)
                                                            <img src="{{ asset($banner->image) }}" alt="Mövcud şəkil" class="img-thumbnail" style="max-height: 200px;">
                                                        @else
                                                            <div class="alert alert-warning mb-0">Şəkil yoxdur</div>
                                                        @endif
                                                    </div>
                                                    
                                                    <!-- Yeni şəkil önizləməsi -->
                                                    <div id="image-preview" class="mt-3 d-none">
                                                        <label class="form-label d-block">Yeni Şəkil</label>
                                                    ...
                                                    <div class="form-check form-switch form-switch-success mt-4">
                                                        <input class="form-check-input" type="checkbox" role="switch" id="status" name="status" {{ $banner->status ? 'checked' : '' }}>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_az') is-invalid @enderror" id="title_az" name="title_az" value="{{ old('title_az', $banner->title_az) }}" required>
                                                        @error('title_az')
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" id="title_en" name="title_en" value="{{ old('title_en', $banner->title_en) }}">
                                                        @error('title_en')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="card border shadow-none mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('title_ru') is-invalid @enderror" id="title_ru" name="title_ru" value="{{ old('title_ru', $banner->title_ru) }}">
                                                        @error('title_ru')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-end">
                                    ...
                                    <a href="{{ route('back.pages.product-banner.index') }}" class="btn btn-secondary">
