...
@section('title', 'Yeni Product Banner')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Yeni Product Banner</h4>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.pages.product-banner.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('back.pages.product-banner.index') }}" class="btn btn-secondary w-md mx-2">Geri qayıt</a>
                            </div>
                        </form>
                    </div>
                </div>
