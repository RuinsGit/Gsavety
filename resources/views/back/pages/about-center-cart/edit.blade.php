                        ...
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="az" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title_az" name="title_az" value="{{ old('title_az', $cart->title_az) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control d-none" id="description_az" name="description_az" rows="5">{{ old('description_az', $cart->description_az) }}</textarea>
                            ...
                            <div class="tab-pane" id="en" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title_en" name="title_en" value="{{ old('title_en', $cart->title_en) }}">
                                    <div class="invalid-feedback" id="title_en-error"></div>
                                </div>
                                <div class="mb-3">
                                    <label for="description_en" class="form-label">Description (EN)</label>
                                    <div id="editor_en"></div>
                                    <textarea class="form-control d-none" id="description_en" name="description_en" rows="5">{{ old('description_en', $cart->description_en) }}</textarea>
                            ...
                            <div class="tab-pane" id="ru" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title_ru" name="title_ru" value="{{ old('title_ru', $cart->title_ru) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control d-none" id="description_ru" name="description_ru" rows="5">{{ old('description_ru', $cart->description_ru) }}</textarea>
