    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Sual Düzənlə</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('back.pages.home-questions.update', $question->id) }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                                ...
                                <div class="tab-pane fade show active" id="az" role="tabpanel">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('title_az') is-invalid @enderror" 
                                               id="title_az" name="title_az" value="{{ old('title_az', $question->title_az) }}" required>
                                        @error('title_az')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description_az') is-invalid @enderror" 
                                                  id="description_az" name="description_az" rows="5" required>{{ old('description_az', $question->description_az) }}</textarea>
                                ...
                                <div class="tab-pane fade" id="en" role="tabpanel">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" 
                                               id="title_en" name="title_en" value="{{ old('title_en', $question->title_en) }}" required>
                                        @error('title_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                                  id="description_en" name="description_en" rows="5" required>{{ old('description_en', $question->description_en) }}</textarea>
                                ...
                                <div class="tab-pane fade" id="ru" role="tabpanel">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('title_ru') is-invalid @enderror" 
                                               id="title_ru" name="title_ru" value="{{ old('title_ru', $question->title_ru) }}" required>
                                        @error('title_ru')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description_ru') is-invalid @enderror" 
                                                  id="description_ru" name="description_ru" rows="5" required>{{ old('description_ru', $question->description_ru) }}</textarea>
...
<script>
    $(document).ready(function() {
        ...
        $('form').on('submit', function(e) {
            ...
            Swal.fire({
                title: 'Əminsiniz?',
                text: 'Dəyişiklikləri yadda saxlamaq istədiyinizə əminsiniz?',
                icon: 'question',
